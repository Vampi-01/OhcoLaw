        ...
        <section ref={sec1} className={`h-sec-1 ${intersectSec1}`}>
          <div className="container">
            <div className="h-sec-1-content">
              ...
              <div>
                <p className="text">
                  This is a sample Text. Only small description Here. This is a
                  sample Text. Only a small description Here. This is a sample
                  Text. Only a small description Here.This is a sample Text.
                  Only small description Here. This is a sample Text. Only a
                  small description Here. This is a sample Text. Only a small
          ...
          <div className="container">
            <div className="h-sec-2-content">
              ...
              <div className="sign">
                ...
                <p className="sign-post sec-2-text">Senior Advocate OH Law </p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            <div className="h-sec-3-content">
              <div className="div">
                ...
                <h2 className="heading center sec-3-gap">Our Practice Area</h2>
              </div>
